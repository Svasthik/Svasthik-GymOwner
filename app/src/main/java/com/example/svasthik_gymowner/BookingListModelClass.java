...
public class BookingListModelClass {
    ...
    public BookingListModelClass(String name, String id, String time, String imageUrl, String phone, String otp, String email, String targetGym, String address, String price,String image,String slotValue) {
        this.name = name;
        this.id = id;
        this.time = time;
